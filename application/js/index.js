...
document.getElementById('riswana-btn').onclick = () => navigateTo('../html/course_materials.html');
document.getElementById('shashi-btn').onclick = () => navigateTo('../html/attendance/attendance.html');
